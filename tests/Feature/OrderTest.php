...
it('can checkout a cart and create an order', function () {
    ...
    $product1 = Product::factory()->create(['shop_id' => $shop1->id, 'price' => 1000, 'stock_quantity' => 10, 'price_type' => 'Unit']);
    $product2 = Product::factory()->create(['shop_id' => $shop2->id, 'price' => 2000, 'stock_quantity' => 5, 'price_type' => 'Unit']);
...
it('automatically completes order when all suborders are completed', function () {
    ...
    $product = Product::factory()->create(['shop_id' => $shop->id, 'price_type' => 'Unit']);
